 ...
 * @param {Array.<{0: number, 1: number}>} [durations] start and end indexes of
 * sessionData to export.
 * @param {string} trackName The formatted name of the track to include in the
 * file.
 * @param {string} sessionName The formatted name of the session to include in
 * the file.
 */
...
Export.exportRawCSV = function(sessionData, durations, trackName, sessionName) {
  ...
  let lastLng = 0; let lastLat = 0; let lastAlt = 0; let lastAcc = 0;
  for (let i = 0; i < intData.length; i++) {
